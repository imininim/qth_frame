...
BEGIN_NAMESPACE
	...
	*/
	...
	{
	public:
		static T* Create()				{ return new T(sizeof(Object), sizeof(Object) * 256);}
	...
	*/
	...
	{
	public:
		typedef Singleton<FixedAllocator, 0, CreateFixedObjectNew<FixedAllocator, T>, ThreadingModel> AllocSingeleton;
